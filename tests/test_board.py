...
class TestBoard(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(len(self.board.__points_status__), 24)  # Assuming 24 points in backgammon
    ...
    def test_move_checker(self):
        ...
        self.board.move_checker('white', 0, 1)  # Mueve una ficha blanca del punto 0 al 1
